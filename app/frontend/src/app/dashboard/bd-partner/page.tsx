...
import { Users, Package, TrendingUp, DollarSign, Plus, Eye, Clock, CheckCircle, LayoutDashboard, Building2 } from "lucide-react"
				...
				<Card>
					...
					<CardContent className="space-y-3">
						{quickActions.map((action) => (
							<Button key={action.name} className="w-full justify-start bg-transparent" variant="outline">
